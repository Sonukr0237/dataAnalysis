...
if(file!=None):
    ...
    with st.expander('Groupby your columns'):
        ...
        with col2:
            operation_col = st.selectbox('Choose column for your operation', options=list(data.columns))
        with col3:
        ...
        if(groupby_cols):
            ...
            graphs = st.selectbox('Choose your graphs', options=['line', 'bar', 'pie', 'scatter', 'sunburst'])
            if(graphs=='line'):
